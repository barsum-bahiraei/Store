...
public interface IAccountRepository
{
    ...
    Task<List<RoleEntity>> RoleListAsync(string email, CancellationToken cancellation);
    Task<List<PermissionEntity>> PermissionListAsync(string email, CancellationToken cancellation);
