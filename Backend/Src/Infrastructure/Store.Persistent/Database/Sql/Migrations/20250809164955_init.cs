    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Accesss", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RoleAccess", x => new { x.AccessId, x.RolesId });
                    table.ForeignKey(
                        name: "FK_RoleAccess_Accesss_AccessId",
                        column: x => x.AccessId,
                        principalTable: "Accesss",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RoleAccess_Roles_RolesId",
                        column: x => x.RolesId,
