        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TargetName = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsPhoneNumberVerified = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CategoriesAttributes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CategoriesAttributes_Attributes_AttributeId",
                        column: x => x.AttributeId,
                        principalTable: "Attributes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CategoriesAttributes_Categories_CategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsShow = table.Column<bool>(type: "boolean", nullable: true, defaultValue: true),
                    UserId = table.Column<int>(type: "integer", nullable: false),
                    ProductId = table.Column<int>(type: "integer", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CategoriesAttributes_AttributeId",
                table: "CategoriesAttributes",
                column: "AttributeId");

            migrationBuilder.CreateIndex(
                name: "IX_CategoriesAttributes_CategoryId_AttributeId",
                table: "CategoriesAttributes",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Files_TableName_TargetName_TargetId",
                table: "Files",
                columns: new[] { "TableName", "TargetName", "TargetId" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductsAttributes_ProductId_AttributeId",
                table: "ProductsAttributes",
            ...
            migrationBuilder.CreateIndex(
                ...
                table: "RoleAccess",
                columns: new[] { "RoleId", "ControllerName", "ActionName" },
                unique: true);
